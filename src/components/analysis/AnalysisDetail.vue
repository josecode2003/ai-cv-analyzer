...
<div class="analysis-header">
  ...
  <div>
    ...
    <p>
      {{
        analysis.summary ||
        'No se ha generado un resumen para este CV.'
      }}
    </p>
...
<div class="analysis-section">
  ...
  >
    ...
    <div
      ...
      :key="
        `${experience.company || 'company'}-${experience.position || 'position'}-${index}`
      "
      class="timeline-item"
    >
...
<div class="analysis-section">
  ...
  >
    ...
    <div
      ...
      :key="
        `${education.degree || 'degree'}-${education.institution || 'institution'}-${index}`
      "
...
<div class="analysis-section">
  ...
  <div class="skill-group">
    ...
    <div
      v-if="analysis.skills?.technical?.length"
      class="tag-list"
    >
    ...
    <p
      ...
      class="empty-text"
    >
      No se han detectado tecnologías.
    </p>
  ...
  <div class="skill-group">
    ...
    <div
      v-if="analysis.skills?.soft?.length"
      class="tag-list"
    >
    ...
    <p
      ...
      class="empty-text"
    >
      No se han detectado competencias.
    </p>
...
>
  ...
  <div class="certifications-list">
    ...
    <div
      ...
      :key="
        `${certification.name || 'certification'}-${index}`
      "
